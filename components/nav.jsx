...
export default function Nav() {
  return (
    <nav className="bg-gray-800 py-2.5 mb-4 shadow-lg">
      <div className="container flex flex-wrap justify-around items-center mx-40">
        <a href="/" className="flex items-center mr-80">
          <img
